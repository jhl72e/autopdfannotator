/**
 * Example: Using Type Validators with AnnotationRenderer
 *
 * This example demonstrates how to use the validator system to normalize
 * potentially invalid annotation data before passing it to the renderer.
 */

import { AnnotationRenderer } from '../src/core/AnnotationRenderer.js';
...
// Normalize data BEFORE passing to renderer
...
// Pass normalized data to renderer
